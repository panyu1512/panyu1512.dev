...
export const About = () => {
  return (
    ...
    >
        ...
        <p className="mb-3">
            I am a dedicated <span className="text-[#9028A3] font-bold">software engineer</span> with more than two years of experience in full-stack web development, 
            where I have honed my skills in <span className="text-[#9028A3] font-bold">JavaScript</span>, <span className="text-[#9028A3] font-bold">Python</span>, <span className="text-[#9028A3] font-bold">React</span>, <span className="text-[#9028A3] font-bold">Angular</span> and <span className="text-[#9028A3] font-bold">Django</span>. 
